...
<solution name="TextGenGen" uuid="2429ba7e-dca6-48f7-8628-d00e9ac44245" moduleVersion="0">
  <models>
    <modelRoot type="default" contentPath="${module}">
      <sourceRoot location="models" />
    </modelRoot>
    <modelRoot type="java_source_stubs" contentPath="${module}/../../java_src/EditorToText_IDEA">
