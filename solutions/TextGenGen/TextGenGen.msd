...
<solution name="TextGenGen" uuid="2429ba7e-dca6-48f7-8628-d00e9ac44245" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
    ...
    <modelRoot contentPath="${module}/../../textGenGen/java_src/EditorToText_IDEA/src" type="java_source_stubs">
      <sourceRoot location="." />
    </modelRoot>
  </models>
  <sourcePath>
    <source path="${module}/../../textGenGen/java_src/EditorToText_IDEA/src" />
  </sourcePath>
  <dependencies>
